...
"""
Написать приложение, которое собирает основные новости с сайтов mail.ru, lenta.ru,
...
def request_to_yandex():
    ...
    # Парсинг в августе 2020. Структура страницы изменилась по сравнению с июлем 2020
